...
TEST(parentheses) {
	...
	// (a + b) * a
	ASSERT_INSTRUCTION(ADD_LL, 2, 0, 1);
	ASSERT_INSTRUCTION(MUL_LL, 2, 2, 0);

	// (a + b) * (c + a)
	ASSERT_INSTRUCTION(ADD_LL, 3, 0, 1);
	ASSERT_INSTRUCTION(ADD_LL, 4, 2, 0);
	ASSERT_INSTRUCTION(MUL_LL, 3, 3, 4);

	// (a + b) * (c + a) * (b + a)
	ASSERT_INSTRUCTION(ADD_LL, 4, 0, 1);
	ASSERT_INSTRUCTION(ADD_LL, 5, 2, 0);
	ASSERT_INSTRUCTION(MUL_LL, 4, 4, 5);
	ASSERT_INSTRUCTION(ADD_LL, 5, 1, 0);
	ASSERT_INSTRUCTION(MUL_LL, 4, 4, 5);
...
TEST(conditional) {
	...
	// a == b
	ASSERT_INSTRUCTION(NEQ_LL, 0, 1, 0);
	ASSERT_JMP(3);
	ASSERT_INSTRUCTION(MOV_LP, 2, TRUE_TAG, 0);
	ASSERT_JMP(2);
	...
	// a < b
	ASSERT_INSTRUCTION(GE_LL, 0, 1, 0);
	ASSERT_JMP(3);
	...
	// b >= c
	ASSERT_INSTRUCTION(LT_LL, 1, 2, 0);
	ASSERT_JMP(3);
	...
	// a != c
	ASSERT_INSTRUCTION(EQ_LL, 0, 2, 0);
	ASSERT_JMP(3);
...
TEST(and) {
	...
	ASSERT_INSTRUCTION(NEQ_LI, 1, 4, 0);
	ASSERT_JMP(5);
	ASSERT_INSTRUCTION(NEQ_LI, 2, 5, 0);
	ASSERT_JMP(3);
	ASSERT_INSTRUCTION(MOV_LP, 3, TRUE_TAG, 0);
	ASSERT_JMP(2);
	ASSERT_INSTRUCTION(MOV_LP, 3, FALSE_TAG, 0);
...
TEST(and_or_1) {
	...
	ASSERT_INSTRUCTION(NEQ_LI, 2, 5, 0);
	ASSERT_JMP(3);
	ASSERT_INSTRUCTION(MOV_LP, 6, TRUE_TAG, 0);
	ASSERT_JMP(2);
	ASSERT_INSTRUCTION(MOV_LP, 6, FALSE_TAG, 0);
...
TEST(and_or_2) {
	...
	ASSERT_INSTRUCTION(MOV_LI, 1, 4, 0);
	ASSERT_INSTRUCTION(MOV_LI, 2, 5, 0);
	ASSERT_INSTRUCTION(MOV_LI, 3, 6, 0);
	...
	ASSERT_INSTRUCTION(NEQ_LI, 2, 5, 0);
	ASSERT_JMP(5);
	ASSERT_INSTRUCTION(NEQ_LI, 3, 6, 0);
	ASSERT_JMP(3);
	ASSERT_INSTRUCTION(MOV_LP, 4, TRUE_TAG, 0);
	ASSERT_JMP(2);
	ASSERT_INSTRUCTION(MOV_LP, 4, FALSE_TAG, 0);
	...
	ASSERT_INSTRUCTION(NEQ_LI, 3, 6, 0);
	ASSERT_JMP(3);
	ASSERT_INSTRUCTION(MOV_LP, 7, TRUE_TAG, 0);
	ASSERT_JMP(2);
	ASSERT_INSTRUCTION(MOV_LP, 7, FALSE_TAG, 0);
